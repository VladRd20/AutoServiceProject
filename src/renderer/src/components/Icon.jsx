...
// Set de iconite inline (stil "outline", 24x24, stroke curent) - randate
// identic pe orice SO, spre deosebire de emoji/caractere Unicode. Fara
// dependinta externa: aplicatia ramane complet functionala offline.
const PATHS = {
  ...
  car: 'M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18 10l-2.7-4.5A2 2 0 0 0 13.6 4.5H8.4a2 2 0 0 0-1.7 1L4 10l-2.5 1.1C.7 11.3 0 12.1 0 13v3c0 .6.4 1 1 1h2M7 17h10M5 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0ZM15 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0Z',
